...
puts 'DEFAULT Events'
Event.create!(:contact_email=>"chrismayu@gmail.com", :contact_person =>"Chris Mayu", :description=>"Shortest Description Ever!!", :event_time => "09/24/2013 19:30", :event_start_time => "09/24/2013 19:30",  :event_date => "09/24/2013 19:30", :event_name => "Christmas Dinner", :location =>"LifeChuch", :remove_event_date => "09/24/2015 19:30")
Event.create!(:contact_email=>"chrismayu@gmail.com", :contact_person =>"Chris Mayu", :description=>"Shortest Description Ever!!", :event_time => "09/24/2013 19:30", :event_start_time => "09/24/2013 19:30",  :event_date => "09/24/2013 19:30", :event_name => "Easter Service", :location =>"LifeChuch", :remove_event_date => "09/24/2015 19:30")
Event.create!(:contact_email=>"chrismayu@gmail.com", :contact_person =>"Chris Mayu", :description=>"Shortest Description Ever!!", :event_time => "09/24/2013 19:30", :event_start_time => "09/24/2013 19:30",  :event_date => "09/24/2013 19:30", :event_name => "Guest Speaker", :location =>"LifeChuch", :remove_event_date => "09/24/2015 19:30")
Event.create!(:contact_email=>"chrismayu@gmail.com", :contact_person =>"Chris Mayu", :description=>"Shortest Description Ever!!", :event_time => "09/24/2013 19:30", :event_start_time => "09/24/2013 19:30",  :event_date => "09/24/2013 19:30", :event_name => "Chris' B-Day", :location =>"LifeChuch", :remove_event_date => "09/24/2015 19:30")
Event.create!(:contact_email=>"chrismayu@gmail.com", :contact_person =>"Chris Mayu", :description=>"Shortest Description Ever!!", :event_time => "09/24/2013 19:30", :event_start_time => "09/24/2013 19:30",  :event_date => "09/24/2013 19:30", :event_name => "Summer Picnic", :location =>"LifeChuch", :remove_event_date => "09/24/2015 19:30")
Event.create!(:contact_email=>"chrismayu@gmail.com", :contact_person =>"Chris Mayu", :description=>"Shortest Description Ever!!", :event_time => "09/24/2013 19:30", :event_start_time => "09/24/2013 19:30",  :event_date => "09/24/2013 19:30", :event_name => "Chuch Cleanning Bee", :location =>"LifeChuch", :remove_event_date => "09/24/2015 19:30")
