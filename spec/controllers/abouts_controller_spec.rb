...
describe AboutsController do
  ...
  let(:valid_attributes) { { "service_day_1" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved about as @about" do
        ...
        post :create, {:about => { "service_day_1" => "invalid value" }}, valid_session
        assigns(:about).should be_a_new(About)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested about" do
        ...
        About.any_instance.should_receive(:update_attributes).with({ "service_day_1" => "MyString" })
        put :update, {:id => about.to_param, :about => { "service_day_1" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the about as @about" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        About.any_instance.stub(:save).and_return(false)
        put :update, {:id => about.to_param, :about => { "service_day_1" => "invalid value" }}, valid_session
        assigns(:about).should eq(about)
      end
